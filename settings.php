...
define("LOCK_CHANNEL_ENTRY_DESCRIPTION", "Lock entry if the entry is currently being edited by another user.");
...
class lock_channel_entry_settings
{
    ...
    {
        return md5(sprintf("object_id=%d&session_id=%s&salt=%s", $object_id, $session_id, LOCK_CHANNEL_ENTRY_SALT));
    }
}
